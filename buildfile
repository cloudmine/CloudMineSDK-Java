...
define 'cloudmine-javasdk' do
  project.version = '0.1'
  compile.with ANDROID, HTTP_CORE, HTTP_CLIENT, HTTP_NIO, HTTP_ASYNC, JACKSON, JACKSON_CORE, JACKSON_ANNOTATIONS, LOGGING_BASE, LOGGING_TYPE, COMMONS, JODA, ROBOLECTRIC
  package :jar
end
