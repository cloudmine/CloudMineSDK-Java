...
public class CMWebService {
    ...
    public void asyncCompleteSocialLogin(String token, String challenge, Callback<CMSocialLoginResponse> callback) {
        HttpGet get = createCompleteSocialGet(token, challenge);
